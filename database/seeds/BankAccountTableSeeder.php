...
class BankAccountTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $bank_acct_records = [
            ...
            ['id' => 5, 'corporate_name' => 'SPV2 SERVICES LIMITED', 'rc_number' => 'RC896654', 'email' => 'support@spv2.com', 'account' => '1015964093', 'available_balance' => '50000000.78', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
        ];
